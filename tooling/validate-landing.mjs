...
// og, собранная из hero, переживёт обрезку хуже кадра, снятого под неё.
if (media.og && media.hero && media.og.src === media.hero.src) {
  warn('медиа: og совпадает с hero — под превью в мессенджерах лучше отдельный кадр');
}
